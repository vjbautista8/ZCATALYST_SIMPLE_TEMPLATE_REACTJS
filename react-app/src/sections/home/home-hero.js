...
const StyledRoot = styled('div')(({ theme }) => ({
  ...bgGradient({
    ...
    imgUrl: '/app/assets/background/overlay_3.jpg',
  }),
  width: '100%',
  height: '100vh',
  position: 'relative',
        ...
        <Stack spacing={2} direction="row" justifyContent="center">
          {['figma', 'js', 'ts', 'nextjs', 'vite'].map((platform) => (
            <m.div key={platform} variants={varFade().in}>
              <Box
                component="img"
                src={`/app/assets/icons/platforms/ic_${platform}.svg`}
    ...
    >
      ...
      >
        <Box
          ...
          src={
            isLight
              ? `/app/assets/images/home/hero/light_1.webp`
              : `/app/assets/images/home/hero/dark_1.webp`
          }
      ...
      >
        <Box
          ...
          src={
            isLight
              ? `/app/assets/images/home/hero/light_2.webp`
              : `/app/assets/images/home/hero/dark_2.webp`
          }
          sx={{ position: 'absolute', mt: -5 }}
        />
        <Box
